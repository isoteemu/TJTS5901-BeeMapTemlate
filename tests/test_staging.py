...
if not os.getenv("WEBSITE_STAGING"):
    pytest.skip("No $WEBSITE_STAGING defined, skipping availability tests", allow_module_level=True)
...
class AvailabilityTest(unittest.TestCase):
    def test_availability(self):
        ...
        self.assertEqual(status_code, 200, f"Website {url!r} availability failed. Returned code was {status_code!r}.")
